...
export class ElementHandle {
   ...
   * @param {!T} element
   * @param {FunctionalTestController} controller
   * @package
   */
...
export class ControllerPromise {
   ...
   * @param {function(TYPE,function(TYPE): ?TYPE): !Promise} waitForValue
  */
  constructor(executorOrPromise, waitForValue) {
    ...
    return this.promise_.catch(onRejected);
  }

 	/** @override */
  finally(onFinally) {
    return this.promise_.finally(onFinally);
  }

  /** @override */
  then(opt_onFulfilled, opt_onRejected) {
    return this.promise_.then(opt_onFulfilled, opt_onRejected);
  }
}
